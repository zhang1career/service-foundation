...
class TestConfigEntryService(SimpleTestCase):
    ...
    def test_create_success(self, _norm, mock_repo, mock_bump, _oc):
        mock_repo.create_entry.return_value = _entry_row(id=3, rid_id=10)
        out = ConfigEntryService.create(10, "app.x", "{}", '{"x":1}')
        mock_repo.create_entry.assert_called_once_with(10, "app.x", "{}", '{"x":1}')
    ...
    def test_update_with_condition_calls_validate(
        ...
        mock_repo.update_entry.assert_called_once_with(5, None, '{"env":"p"}', None)
    ...
    def test_update_condition_none_skips_validate(self, mock_norm, mock_repo, mock_bump, _oc):
        ...
        mock_repo.update_entry.assert_called_once_with(1, "new.key", None, None)
