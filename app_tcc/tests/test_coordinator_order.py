...
class CoordinatorOrderMockedTests(SimpleTestCase):
    ...
    def test_try_order_then_confirm_reverse(
        ...
        self.assertEqual(try_calls[0][1]["x_request_id"], "8000-0")
        self.assertEqual(try_calls[0][1]["x_request_id"], try_calls[0][1]["idempotency_key"])
        self.assertEqual(try_calls[1][1]["x_request_id"], "8000-1")
        ...
        self.assertEqual(confirm_calls[0][1]["x_request_id"], "8000-1")
        self.assertEqual(confirm_calls[1][1]["x_request_id"], "8000-0")

        self.assertEqual(g.idem_key, 8000)
        self.assertEqual(g.status, GlobalTxStatus.COMMITTED)
        self.assertEqual(branch_by_pk[201].idem_key, "8000-0")
        self.assertEqual(branch_by_pk[202].idem_key, "8000-1")
    ...
    def test_try_failure_cancels_reverse_try_order(
        ...
        self.assertEqual(cancel_calls[0][1]["x_request_id"], "8000-0")
