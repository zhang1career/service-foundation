...
-- ---------------------------------------------------------------------------
-- flow_step.confirm_url (optional when is_need_confirm=0; required when is_need_confirm=1)
-- ---------------------------------------------------------------------------
-- ALTER TABLE flow_step ADD COLUMN confirm_url VARCHAR(2048) NOT NULL DEFAULT '' AFTER compensate_url;
